...
LIVE_OVERLAY_STREAM_POSTPROCESS = get_env_bool("JR_LIVE_OVERLAY_STREAM_POSTPROCESS", True)
ALL_IN_ONE_ENGINE_ENABLED = get_env_bool("JR_ALL_IN_ONE_ENGINE_ENABLED", True)
...
ALL_IN_ONE_STRONG_ENTRY_MIN_EVENTS = get_env_int("JR_ALL_IN_ONE_STRONG_ENTRY_MIN_EVENTS", 3)
ALL_IN_ONE_STRONG_ENTRY_MAX_CADENCE_CV = get_env_float(
    "JR_ALL_IN_ONE_STRONG_ENTRY_MAX_CADENCE_CV",
    0.20,
)
ALL_IN_ONE_STRONG_ENTRY_MIN_STRONG_EVENTS = get_env_int(
    "JR_ALL_IN_ONE_STRONG_ENTRY_MIN_STRONG_EVENTS",
    2,
)
ALL_IN_ONE_STRONG_ENTRY_MIN_STRENGTH_RATIO = get_env_float(
    "JR_ALL_IN_ONE_STRONG_ENTRY_MIN_STRENGTH_RATIO",
    10.0,
)
ALL_IN_ONE_STRONG_ENTRY_MIN_FOOT_PROMINENCE = get_env_float(
    "JR_ALL_IN_ONE_STRONG_ENTRY_MIN_FOOT_PROMINENCE",
    0.0005,
)
ALL_IN_ONE_STRONG_ENTRY_MIN_ROPE_RATIO = get_env_float(
    "JR_ALL_IN_ONE_STRONG_ENTRY_MIN_ROPE_RATIO",
    0.55,
)
ALL_IN_ONE_STRONG_ENTRY_MIN_DUAL_RATIO = get_env_float(
    "JR_ALL_IN_ONE_STRONG_ENTRY_MIN_DUAL_RATIO",
    0.25,
)
ALL_IN_ONE_ENTRY_START_MIN_FOOT_PROMINENCE = get_env_float(
    "JR_ALL_IN_ONE_ENTRY_START_MIN_FOOT_PROMINENCE",
    0.0010,
)
ALL_IN_ONE_ENTRY_BACKFILL_MIN_EVENTS = get_env_int(
    "JR_ALL_IN_ONE_ENTRY_BACKFILL_MIN_EVENTS",
    2,
)
ALL_IN_ONE_ENTRY_BACKFILL_MAX_EVENTS = get_env_int(
    "JR_ALL_IN_ONE_ENTRY_BACKFILL_MAX_EVENTS",
    2,
)
ALL_IN_ONE_ENTRY_BACKFILL_MIN_ABS_FOOT_PROMINENCE = get_env_float(
    "JR_ALL_IN_ONE_ENTRY_BACKFILL_MIN_ABS_FOOT_PROMINENCE",
    0.0008,
)
ALL_IN_ONE_ENTRY_BACKFILL_MIN_GAP_RATIO = get_env_float(
    "JR_ALL_IN_ONE_ENTRY_BACKFILL_MIN_GAP_RATIO",
    0.60,
)
ALL_IN_ONE_ENTRY_BACKFILL_MAX_GAP_RATIO = get_env_float(
    "JR_ALL_IN_ONE_ENTRY_BACKFILL_MAX_GAP_RATIO",
    1.40,
)
ALL_IN_ONE_STABLE_ENTRY_MIN_EVENTS = get_env_int("JR_ALL_IN_ONE_STABLE_ENTRY_MIN_EVENTS", 4)
ALL_IN_ONE_STABLE_ENTRY_MAX_CADENCE_CV = get_env_float(
    "JR_ALL_IN_ONE_STABLE_ENTRY_MAX_CADENCE_CV",
    0.22,
)
ALL_IN_ONE_STABLE_ENTRY_MIN_STRONG_EVENTS = get_env_int(
    "JR_ALL_IN_ONE_STABLE_ENTRY_MIN_STRONG_EVENTS",
    2,
)
ALL_IN_ONE_STABLE_ENTRY_MIN_ROPE_RATIO = get_env_float(
    "JR_ALL_IN_ONE_STABLE_ENTRY_MIN_ROPE_RATIO",
    0.50,
)
ALL_IN_ONE_STABLE_ENTRY_MIN_ABS_FOOT_PROMINENCE = get_env_float(
    "JR_ALL_IN_ONE_STABLE_ENTRY_MIN_ABS_FOOT_PROMINENCE",
    0.0005,
)
ALL_IN_ONE_GAP_FILL_MIN_RATIO = get_env_float(
    "JR_ALL_IN_ONE_GAP_FILL_MIN_RATIO",
    1.50,
)
...
STRICT_IGNORE_BOUNDARY_CANDIDATES = get_env_bool("JR_STRICT_IGNORE_BOUNDARY_CANDIDATES", True)
BOUNDARY_CANDIDATE_MAX_RATIO = get_env_float("JR_BOUNDARY_CANDIDATE_MAX_RATIO", 1.70)
BOUNDARY_CANDIDATE_MAX_HEAD_EVENTS = get_env_int("JR_BOUNDARY_CANDIDATE_MAX_HEAD_EVENTS", 2)
BOUNDARY_CANDIDATE_MAX_TAIL_EVENTS = get_env_int("JR_BOUNDARY_CANDIDATE_MAX_TAIL_EVENTS", 2)
