...
REALTIME_STRICT_GUARDS = get_env_bool("JR_REALTIME_STRICT_GUARDS", True)
REALTIME_STRICT_LOWER_BODY_VIS_MIN = get_env_float("JR_REALTIME_STRICT_LOWER_BODY_VIS_MIN", 0.45)
REALTIME_STRICT_REQUIRE_DUAL_ROPE = get_env_bool("JR_REALTIME_STRICT_REQUIRE_DUAL_ROPE", True)
REALTIME_STRICT_MIN_STRENGTH_RATIO = get_env_float("JR_REALTIME_STRICT_MIN_STRENGTH_RATIO", 1.2)
REALTIME_STRICT_ENTER_MIN_EVENTS = get_env_int("JR_REALTIME_STRICT_ENTER_MIN_EVENTS", 3)
REALTIME_STRICT_STARTUP_LOCKOUT_SECONDS = get_env_float("JR_REALTIME_STRICT_STARTUP_LOCKOUT_SECONDS", 1.2)
