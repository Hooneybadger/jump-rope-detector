...
STRICT_OVERRIDE_ACTIVE_MIN_ROPE_RATIO = get_env_float("JR_STRICT_OVERRIDE_ACTIVE_MIN_ROPE_RATIO", 0.24)
STRICT_OVERRIDE_ACTIVE_MIN_DUAL_RATIO = get_env_float("JR_STRICT_OVERRIDE_ACTIVE_MIN_DUAL_RATIO", 0.03)
STRICT_OVERRIDE_ENTRY_MIN_ROPE_RATIO = get_env_float("JR_STRICT_OVERRIDE_ENTRY_MIN_ROPE_RATIO", 0.30)
STRICT_OVERRIDE_ENTRY_MIN_DUAL_RATIO = get_env_float("JR_STRICT_OVERRIDE_ENTRY_MIN_DUAL_RATIO", 0.10)
STRICT_ACTIVE_FOOT_MOTION_WINDOW = get_env_int("JR_STRICT_ACTIVE_FOOT_MOTION_WINDOW", 8)
STRICT_ACTIVE_FOOT_MOTION_MIN_RATIO = get_env_float("JR_STRICT_ACTIVE_FOOT_MOTION_MIN_RATIO", 0.0)
STRICT_ACTIVE_FOOT_MOTION_MIN_TRUE = get_env_int("JR_STRICT_ACTIVE_FOOT_MOTION_MIN_TRUE", 0)
STRICT_ACTIVE_FOOT_MOTION_ROPE_MIN_RATIO = get_env_float("JR_STRICT_ACTIVE_FOOT_MOTION_ROPE_MIN_RATIO", 0.0)
...
ROPE_ACTIVE_MIN_RATIO = get_env_float("JR_ROPE_ACTIVE_MIN_RATIO", 0.10)
ROPE_ACTIVE_DUAL_MIN_RATIO = get_env_float("JR_ROPE_ACTIVE_DUAL_MIN_RATIO", 0.0)
ROPE_ENTRY_MIN_RATIO = get_env_float("JR_ROPE_ENTRY_MIN_RATIO", 0.16)
ROPE_ENTRY_DUAL_MIN_RATIO = get_env_float("JR_ROPE_ENTRY_DUAL_MIN_RATIO", 0.02)
