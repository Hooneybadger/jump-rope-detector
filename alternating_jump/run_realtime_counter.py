...
def _draw_overlay(
    ...
    _draw_text(frame, stream_state.phase.lower(), (panel_x + 130, panel_y + 34), 0.58, accent, 1)
    status_line = "Ready to count" if count_ready else "Align hips and feet"
    _draw_text(frame, status_line, (panel_x + 130, panel_y + 60), 0.54, (220, 220, 220), 1)
    ...
    try:
        while True:
            ...
            if not args.no_display:
                cv2.imshow("alternating_jump realtime counter", display_frame)
